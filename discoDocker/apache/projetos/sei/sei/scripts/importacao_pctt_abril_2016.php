<?
	try {
		...
		$data[] = array('30.01.01.01', 'N', 'Coleta de dados e acompanhamento das licitações', '100', '0', 'E', null);
		...
		$data[] = array('30.01.02.01', 'N', 'Alteração / renegociação de cláusulas contratuais', '100', '0', 'E', null);
		$data[] = array('30.01.02.02', 'N', 'Acompanhamento contratual ', '100', '0', 'E', 'Procedimentos diversos pertinentes à execução do contrato - assinatura, informação, solicitação.');
		...
		$data[] = array('30.01.03.01', 'N', 'Comunicação / solicitação  de aplicação de penalidades ', '100', '0', 'E', null);
    ...
    $objTabelaAssuntoRN = new TabelaAssuntosRN();
		...
		$objTabelaAssuntoDTO->setStrNome('PCTT abril/2016');
		$objTabelaAssuntoDTO->setNumIdTabelaAssuntos(null);
		$objTabelaAssuntoDTO->setStrDescricao('Plano de Classificação e Tabela de Temporalidade dos Documentos administrativos da Justiça Federal (versão abril/2016)');
