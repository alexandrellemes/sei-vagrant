...
function inicializar(){
  ...
  objAutoCompletarDestinatario = new infraAjaxAutoCompletar('hdnIdContato','txtDestinatario','<?=SessaoSEI::getInstance()->assinarLink('controlador_ajax.php?acao_ajax=contato_auto_completar_acesso_externo')?>');
