  ...
  */
  class InfraMumpsXML {
    ...
    function substituirCaracteresEspeciais2($strDados) {
      for ($i=0; $i<InfraArray::contar($this->minusculas_acentuadas); $i++) {
    ...
    function substituirCaracteresEspeciais($arrResultado) {
      for ($numLinha=2; $numLinha<InfraArray::contar($arrResultado); $numLinha++) {
				for ($numColuna=0; $numColuna<=$this->numColuna; $numColuna++) {
					for ($i=0; $i<InfraArray::contar($this->arrCaracteresEspeciaisHTML); $i++) {
    ...
    function mostrarResultado($arrResultado_resultado) {
      for ($numLinha=0; $numLinha<InfraArray::contar($arrResultado_resultado); $numLinha++) {
				for ($numColuna=0; $numColuna<InfraArray::contar($arrResultado_resultado[$numLinha]); $numColuna++) {
