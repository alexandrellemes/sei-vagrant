...
#divSinPrioridade {position:absolute;left:0%;top:38%;}
...
?>
  ...
  <textarea id="txaDescricao" name="txaDescricao" rows="<?=PaginaSEI::getInstance()->isBolNavegadorFirefox()?'5':'6'?>" onkeypress="return infraLimitarTexto(this,event,500);" class="infraTextarea" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=PaginaSEI::tratarHTML($objAnotacaoDTO->getStrDescricao());?></textarea>
