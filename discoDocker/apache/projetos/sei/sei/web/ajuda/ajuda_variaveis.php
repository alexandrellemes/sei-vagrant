...
try {
  ...
  switch($_GET['acao']){
    ...
    case 'ajuda_variaveis_secao_modelo':
      ...
      $arrVariaveis[] = array('@telefone_fixo_unidade@','Telefone fixo da unidade atual');
      ...
      $arrVariaveis[] = array('@telefone_fixo_destinatario@','Telefone fixo do primeiro destinatário');
      ...
      $arrVariaveis[] = array('@telefone_fixo_interessado@','Telefone fixo do primeiro interessado');
