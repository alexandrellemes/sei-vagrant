  ...
  switch($_GET['acao']){
    ...
    case 'protocolo_pesquisa_rapida':  
      ...
      if ($strPesquisarEm=='P'){
        ...
        $strTituloDescricaoPesquisa = 'Especificação:';
        $numIdSerie = '';
        ...
        $strTituloDescricaoPesquisa = 'Descrição:';
...
function formatarExibicao(){
  if (document.getElementById('optProcessos').checked){
    ...
    document.getElementById('lblDescricaoPesquisa').innerHTML = 'Especificação:';
    ...
    document.getElementById('lblDescricaoPesquisa').innerHTML = 'Descrição:';
