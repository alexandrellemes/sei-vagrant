  ...
  protected function excluirRN0491Controlado($arrObjUsuarioDTO){
    try {
      ...
      for ($i=0;$i<count($arrObjUsuarioDTO);$i++){
        ...
        if (($objAtividadeDTO = $objAtividadeRN->consultarRN0033($objAtividadeDTO))!=null){
          $objInfraException->lancarValidacao('Existem andamentos associados com o usuário '.$objAtividadeDTO->getStrSiglaUsuarioOrigem().'.');
        }
      }
