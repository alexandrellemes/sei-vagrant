...
try {
  ...
  $strHelp = '';
  $strHelp .= 'Orientações sobre a Periodicidade:<br />';
  $strHelp .= ' * Minuto: informe o minuto de execução sem zeros à esquerda.<br />';
  $strHelp .= ' Exemplo: 0,13,7,18,45,... ou simplesmente 42<br /><br />';
  $strHelp .= ' * Hora: informe a hora de execução sem zeros à esquerda.<br />';
  $strHelp .= ' Exemplo: 0,6,12,18,... ou simplesmente 23<br /><br />';
  $strHelp .= ' * Dia da Semana: informe o dia da semana (1-segunda, 2-terça, 3-quarta, 4-quinta, 5-sexta, 6-sábado, 7-domingo) e a hora de execução.<br />';
  $strHelp .= 'Exemplo: 1/0,3/22,... ou simplesmente 7/0<br /><br />';
  $strHelp .= ' * Dia do Mês: informe o dia do mês (1 a 31) e a hora de execução.<br />';
  $strHelp .= 'Exemplo: 10/0,20/12,... ou simplesmente 15/6<br /><br />';
  $strHelp .= ' * Dia do Ano: informe o dia do mês (1 a 31), o mês (1 a 12) e a hora de execução.<br />';
  $strHelp .= 'Exemplo: 10/1/0,20/6/12,... ou simplesmente 15/12/6<br /><br />';
  $strHelp .= 'IMPORTANTE: Os parâmetros devem ser informados separados por vírgula, sempre sem espaços: idOrgao=1 ou idOrgao=4,dtaInicio=27/10/2003,...<br /><br />';
...
#txtParametro {position:absolute;left:0%;top:49%;width:85%;}
...
#txtPeriodicidadeComplemento {position:absolute;left:30%;top:63%;width:55%;}
...
?>
  <label id="lblHelp" for="lblHelp" accesskey="" class="infraLabelOpcional"><?=$strHelp;?></label>
<?
...
?>
  ...
  <input type="text" id="txtPeriodicidadeComplemento" name="txtPeriodicidadeComplemento" class="infraText" value="<?=PaginaInfra::getInstance()->tratarHTML($objInfraAgendamentoTarefaDTO->getStrPeriodicidadeComplemento());?>" onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100" tabindex="<?=PaginaInfra::getInstance()->getProxTabDados()?>" />
