...
try {
  ...
  switch($_GET['acao']){
    case 'perfil_comparar':
      ...
      //dados do sistema destino, qdo a base de comparaçao é local
      ...
      //dados do sistema destino, qdo a base de comparaçao é remota
...
//  echo '<pre>';print_r($arrMergeUnique);print_r($arrMergeForaIntersecao);print_r($arrIntersecao);die('@');
  ...
  //dados destino para comparaçao com base local
...
function validarForm(){
  ...
  if (infraTrim(document.getElementById('pwdBancoSenha').value)=='') {
    ...
    if (infraTrim(document.getElementById('txtOrgaoDestino').value)=='') {
      alert('Informe o Órgão do Sistema Destino.');
...
?>
  <label id="lblOrgaoSistemaOrigem" for="selOrgaoOrigem" accesskey="r" class="infraLabelObrigatorio">Ó<span class="infraTeclaAtalho">r</span>gão do Sistema Origem:</label>
  ...
  <label id="lblOrgaoSistemaDestino" for="txtOrgaoDestino" accesskey="r" class="infraLabelObrigatorio">Ó<span class="infraTeclaAtalho">r</span>gão do Sistema Destino:</label>
