...
class SeiRN extends InfraRN {
  ...
  protected function gerarProcedimentoInternoControlado(EntradaGerarProcedimentoAPI $objEntradaGerarProcedimentoAPI){
    try{
      ...
      if ($arrObjInteressadoAPI!=null) {
        $numInteressados = count($arrObjInteressadoAPI);
      ...
      if ($arrAssuntosAPI!=null) {
        $numAssuntos = count($arrAssuntosAPI);
      ...
      if ($arrIdUnidadesEnvio!=null && count($arrIdUnidadesEnvio)){
      ...
      if (SessaoSEI::getInstance()->getObjServicoDTO()!=null && SessaoSEI::getInstance()->getObjServicoDTO()->getStrSinLinkExterno()=='S'){
        ...
        $objSaidaGerarProcedimentoAPI->setLinkAcesso(SessaoSEIExterna::getInstance($objAcessoExternoDTO->getNumIdAcessoExterno())->assinarLink(ConfiguracaoSEI::getInstance()->getValor('SEI','URL').'/processo_acesso_externo_consulta.php?id_acesso_externo='.$objAcessoExternoDTO->getNumIdAcessoExterno()));
      }else{
  ...
  protected function incluirDocumentoControlado(DocumentoAPI $objDocumentoAPI){
    ...
    try{
      ...
      if (!InfraString::isBolVazia($objDocumentoAPI->getIdProcedimento())) {
        ...
        $objProcedimentoDTO->adicionarCriterio(array('IdProcedimento', 'ProtocoloProcedimentoFormatado', 'ProtocoloProcedimentoFormatadoPesquisa'),
            array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
            array($objDocumentoAPI->getIdProcedimento(), $objDocumentoAPI->getIdProcedimento(), InfraUtil::retirarFormatacao($objDocumentoAPI->getIdProcedimento(),false)),
            array(InfraDTO::$OPER_LOGICO_OR, InfraDTO::$OPER_LOGICO_OR));

      }else{

        $objProcedimentoDTO->adicionarCriterio(array('ProtocoloProcedimentoFormatado', 'ProtocoloProcedimentoFormatadoPesquisa'),
            array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
            array($objDocumentoAPI->getProtocoloProcedimento(), InfraUtil::retirarFormatacao($objDocumentoAPI->getProtocoloProcedimento(),false)),
      ...
      if ($objProcedimentoDTO==null){
        ...
        }else if (InfraString::isBolVazia($objDocumentoAPI->getIdProcedimento()) && !InfraString::isBolVazia($objDocumentoAPI->getProtocoloProcedimento())) {
      ...
      if (strlen($objDocumentoAPI->getConteudoMTOM()) > 0) {
        if ($objDocumentoAPI->getTipo() == ProtocoloRN::$TP_DOCUMENTO_GERADO) {
          throw new InfraException ('Para documento gerado utilizar o elemento "Conteudo" codificado em Base64.');
        }

        if (strlen($objDocumentoAPI->getConteudo()) > 0) {
          throw new InfraException ('Não é possível enviar documento externo utilizando o elemento Conteudo (Base64) e ConteudoMTOM (Binário) ao mesmo tempo.');
        }
      }
      ...
      if ($arrObjDestinatarioAPI!=null) {
        $numDestinatarios = count($arrObjDestinatarioAPI);
      ...
      }else if ($objDocumentoAPI->getIdArquivo()!=null){
        $objAnexoDTO = new AnexoDTO();
      ...
      $strSinBloqueado = $objDocumentoDTO->getStrSinBloqueado();
    	...
    	}else if ($objDocumentoDTO->getObjProtocoloDTO()->getStrStaProtocolo()==ProtocoloRN::$TP_DOCUMENTO_RECEBIDO){
      ...
      if (SessaoSEI::getInstance()->getObjServicoDTO()!=null && SessaoSEI::getInstance()->getObjServicoDTO()->getStrSinLinkExterno() == 'S') {
        ...
        $objSaidaIncluirDocumentoAPI->setLinkAcesso(SessaoSEIExterna::getInstance($objAcessoExternoDTO->getNumIdAcessoExterno())->assinarLink(ConfiguracaoSEI::getInstance()->getValor('SEI', 'URL') . '/documento_consulta_externa.php?id_acesso_externo=' . $objAcessoExternoDTO->getNumIdAcessoExterno() . '&id_documento=' . $objDocumentoDTOGerado->getDblIdDocumento()));
      }else{
        $objSaidaIncluirDocumentoAPI->setLinkAcesso(ConfiguracaoSEI::getInstance()->getValor('SEI', 'URL') . '/controlador.php?acao=procedimento_trabalhar&id_procedimento=' . $objDocumentoDTO->getDblIdProcedimento() . '&id_documento=' . $objDocumentoDTOGerado->getDblIdDocumento());
      }
  ...
  protected function listarContatosConectado(EntradaListarContatosAPI $objEntradaListarContatosAPI){
    try{
      ...
      }else if (!InfraString::isBolVazia($objEntradaListarContatosAPI->getIdContatos())){
      ...
      }else if(!is_numeric($numPaginaRegistros) || $numPaginaRegistros <= 0  || $numPaginaRegistros > 1000){
    ...
    try{
      ...
      if (count($arrObjMarcadorDTO)) {
        ...
        foreach($arrObjMarcadorDTO as $objMarcadorDTO){
          ...
          $objMarcadorAPI->setIcone('data:image/png;base64,'.base64_encode(file_get_contents(dirname(__FILE__).'/../imagens/'.$arrIcones[$objMarcadorDTO->getStrStaIcone()]->getStrArquivo())));
  ...
  protected function definirMarcadorControlado($arrObjDefinicaoMarcadorAPI){
    try{
      ...
      foreach($arrObjDefinicaoMarcadorAPI as $objDefinicaoMarcadorAPI) {
        ...
        $objAndamentoMarcadorRN->gerenciar($objAndamentoMarcadorDTO);
      }
    ...
    try{
      ...
      if ($objEntradaListarAndamentosMarcadoresAPI->getMarcadores()!=null){
        ...
        if (($posNull = array_search(null, $arr)) !== false){
          ...
          $objAndamentoMarcadorDTO->adicionarCriterio(array('IdMarcador','IdMarcador'),
        ...
        foreach ($arrObjAndamentoMarcadorDTO as $objAndamentoMarcadorDTO) {
          ...
          if ($objAndamentoMarcadorDTO->getNumIdMarcador()!=null) {
            ...
            if (!isset($arrCacheIcones[$objAndamentoMarcadorDTO->getStrStaIconeMarcador()])) {
              $arrCacheIcones[$objAndamentoMarcadorDTO->getStrStaIconeMarcador()] = 'data:image/png;base64,' . base64_encode(file_get_contents(dirname(__FILE__).'/../imagens/' . $arrIcones[$objAndamentoMarcadorDTO->getStrStaIconeMarcador()]->getStrArquivo()));
            }
    ...
    try{
      ...
      if (count($arrObjContatoAPI)) {
        ...
        foreach($arrObjContatoAPI as $objContatoAPI) {
          ...
          $objContatoDTO->setStrTelefoneFixo($objContatoAPI->getTelefoneFixo());
          ...
          try {
            ...
            if ($objContatoDTO->getNumIdContato()!=null){
              ...
              if ($objContatoDTOBanco != null && $SinAtivo!=null) {
                ...
                } else if ($objContatoDTOBanco->getStrSinAtivo() == 'N' && $SinAtivo == 'S' && $StaOperacao != 'R') {
  ...
  protected function consultarProcedimentoConectado(EntradaConsultarProcedimentoAPI $objEntradaConsultarProcedimentoAPI){
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarAssuntos())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarInteressados())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarObservacoes())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarAndamentoGeracao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarAndamentoConclusao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarUltimoAndamento())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarUnidadesProcedimentoAberto())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarProcedimentosRelacionados())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarProcedimentoAPI->getSinRetornarProcedimentosAnexados())) {
      ...
      if (SessaoSEI::getInstance()->getObjServicoDTO()!=null && SessaoSEI::getInstance()->getObjServicoDTO()->getStrSinLinkExterno() == 'S') {
        ...
        $objSaidaConsultarProcedimentoAPI->setLinkAcesso(SessaoSEIExterna::getInstance($objAcessoExternoDTO->getNumIdAcessoExterno())->assinarLink(ConfiguracaoSEI::getInstance()->getValor('SEI', 'URL') . '/processo_acesso_externo_consulta.php?id_acesso_externo=' . $objAcessoExternoDTO->getNumIdAcessoExterno()));
      }else{
  ...
  protected function consultarPublicacaoConectado(EntradaConsultarPublicacaoAPI $objEntradaConsultarPublicacaoAPI){
    ...
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarPublicacaoAPI->getSinRetornarAndamento())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarPublicacaoAPI->getSinRetornarAssinaturas())) {
  ...
  protected function confirmarDisponibilizacaoPublicacaoControlado(EntradaconfirmarDisponibilizacaoPublicacaoAPI $objEntradaConfirmarDisponibilizacaoPublicacaoAPI)
  {
    try{
      ...
      throw new InfraException('Erro processando confirmação de disponibilização.', $e);
    }
  }
  ...
  protected function consultarProcedimentoIndividualConectado(EntradaConsultarProcedimentoIndividualAPI $objConsultaProcedimentoIndividualAPI){
    ...
    try{
      ...
      $objOrgaoDTO->setNumIdOrgao(array($objConsultaProcedimentoIndividualAPI->getIdOrgaoProcedimento(), $objConsultaProcedimentoIndividualAPI->getIdOrgaoUsuario()), InfraDTO::$OPER_IN);
  ...
  protected function consultarDocumentoConectado(EntradaConsultarDocumentoAPI $objEntradaConsultarDocumentoAPI){
    try{
      ...
      }else if ($objEntradaConsultarDocumentoAPI->getProtocoloDocumento()!=null){
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarDocumentoAPI->getSinRetornarAndamentoGeracao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarDocumentoAPI->getSinRetornarAssinaturas())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarDocumentoAPI->getSinRetornarPublicacao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarDocumentoAPI->getSinRetornarCampos())) {
      ...
      if (SessaoSEI::getInstance()->getObjServicoDTO()!=null && SessaoSEI::getInstance()->getObjServicoDTO()->getStrSinLinkExterno() == 'S') {
        $objAcessoExternoDTO = $this->obterAcessoExternoSistema($objDocumentoDTO->getDblIdProcedimento());
        $objSaidaConsultarDocumentoAPI->setLinkAcesso(SessaoSEIExterna::getInstance($objAcessoExternoDTO->getNumIdAcessoExterno())->assinarLink(ConfiguracaoSEI::getInstance()->getValor('SEI', 'URL') . '/documento_consulta_externa.php?id_acesso_externo=' . $objAcessoExternoDTO->getNumIdAcessoExterno() . '&id_documento=' . $objDocumentoDTO->getDblIdDocumento()));
      }else{
        $objSaidaConsultarDocumentoAPI->setLinkAcesso(ConfiguracaoSEI::getInstance()->getValor('SEI', 'URL') . '/controlador.php?acao=procedimento_trabalhar&id_procedimento=' . $objDocumentoDTO->getDblIdProcedimento() . '&id_documento=' . $objDocumentoDTO->getDblIdDocumento());
      }
  ...
  protected function consultarBlocoConectado(EntradaConsultarBlocoAPI $objEntradaConsultarBlocoAPI){
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaConsultarBlocoAPI->getSinRetornarProtocolos())) {
      ...
      $objBlocoRN = new BlocoRN();
      $objBlocoDTORet = $objBlocoRN->consultarRN1276($objBlocoDTO2);

      if ($objBlocoDTORet==null){
        throw new InfraException('Bloco '.$objEntradaConsultarBlocoAPI->getIdBloco().' não encontrado.');
      }

      if ( $objBlocoDTORet->getNumIdUnidade()!=SessaoSEI::getInstance()->getNumIdUnidadeAtual()){

        $bolDisponibilizadoUnidade = false;
        if ($objBlocoDTORet->getStrStaEstado()==BlocoRN::$TE_DISPONIBILIZADO){

          $objRelBlocoUnidadeDTO = new RelBlocoUnidadeDTO();
          $objRelBlocoUnidadeDTO->setNumIdBloco($objEntradaConsultarBlocoAPI->getIdBloco());
          ...
          $bolDisponibilizadoUnidade = ($objRelBlocoUnidadeRN->contarRN1305($objRelBlocoUnidadeDTO)>0);
        }

        if (!$bolDisponibilizadoUnidade){
      ...
      $objRelBlocoUnidadeDTO->setNumIdBloco($objBlocoDTORet->getNumIdBloco());
  ...
  protected function enviarProcessoControlado(EntradaEnviarProcessoAPI $objEntradaEnviarProcessoAPI){
    ...
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaEnviarProcessoAPI->getSinManterAbertoUnidade())) {
      ...
      if (InfraString::isBolVazia($objEntradaEnviarProcessoAPI->getSinRemoverAnotacao())){
        $objEntradaEnviarProcessoAPI->setSinRemoverAnotacao('N');
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaEnviarProcessoAPI->getSinRemoverAnotacao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaEnviarProcessoAPI->getSinEnviarEmailNotificacao())) {
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaEnviarProcessoAPI->getSinDiasUteisRetornoProgramado())) {
      ...
      if (InfraString::isBolVazia($objEntradaEnviarProcessoAPI->getSinReabrir())){
        $objEntradaEnviarProcessoAPI->setSinReabrir('N');
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaEnviarProcessoAPI->getSinReabrir())) {
      ...
      $objEnviarProcessoDTO->setStrSinRemoverAnotacoes($objEntradaEnviarProcessoAPI->getSinRemoverAnotacao());
			$objEnviarProcessoDTO->setDtaPrazo($objEntradaEnviarProcessoAPI->getDataRetornoProgramado());
      $objEnviarProcessoDTO->setNumDias($objEntradaEnviarProcessoAPI->getDiasRetornoProgramado());
      $objEnviarProcessoDTO->setStrSinDiasUteis($objEntradaEnviarProcessoAPI->getSinDiasUteisRetornoProgramado());
  ...
  protected function lancarAndamentoControlado(EntradaLancarAndamentoAPI $objEntradaLancarAndamentoAPI){
    ...
    try{
      ...
      if (!InfraString::isBolVazia($objEntradaLancarAndamentoAPI->getIdTarefaModulo())){
        ...
        }else if (count($arrObjTarefaDTO) > 1){
  ...
  protected function listarAndamentosConectado(EntradaListarAndamentosAPI $objEntradaListarAndamentosAPI){
    ...
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaListarAndamentosAPI->getSinRetornarAtributos())) {
  ...
  protected function atribuirProcessoControlado(EntradaAtribuirProcessoAPI $objEntradaAtribuirProcessoAPI){
    ...
    try{
      ...
      }else if (!InfraUtil::isBolSinalizadorValido($objEntradaAtribuirProcessoAPI->getSinReabrir())) {
        $objInfraException->adicionarValidacao('Sinalizador de reabertura automática de processo inválido.');
      }
  ...
  private function validarCriteriosUnidade($strStaOperacaoServico){
    ...
    if ($objServicoDTO!=null) {
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdUnidade', 'IdUnidade'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array(SessaoSEI::getInstance()->getNumIdUnidadeAtual(), null),
          InfraDTO::$OPER_LOGICO_OR);
  ...
  private function validarCriteriosUnidadeProcessoDocumento($strStaOperacaoServico, DocumentoDTO $objDocumentoDTO){
    ...
    if ($objServicoDTO!=null) {
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array(null, SessaoSEI::getInstance()->getNumIdUnidadeAtual(), null),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c3');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array(null, null, $objDocumentoDTO->getNumIdTipoProcedimentoProcedimento()),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c4');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array($objDocumentoDTO->getNumIdSerie(), SessaoSEI::getInstance()->getNumIdUnidadeAtual(), null),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c5');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array($objDocumentoDTO->getNumIdSerie(), null, $objDocumentoDTO->getNumIdTipoProcedimentoProcedimento()),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c6');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array(null, SessaoSEI::getInstance()->getNumIdUnidadeAtual(), $objDocumentoDTO->getNumIdTipoProcedimentoProcedimento()),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c7');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdUnidade', 'IdTipoProcedimento'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array($objDocumentoDTO->getNumIdSerie(), SessaoSEI::getInstance()->getNumIdUnidadeAtual(), $objDocumentoDTO->getNumIdTipoProcedimentoProcedimento()),
          array(InfraDTO::$OPER_LOGICO_AND, InfraDTO::$OPER_LOGICO_AND),
          'c8');
  ...
  private function validarCriteriosUnidadeProcesso($strStaOperacaoServico, ProcedimentoDTO $objProcedimentoDTO){
    ...
    if ($objServicoDTO!=null) {
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdTipoProcedimento', 'IdUnidade'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array(null, SessaoSEI::getInstance()->getNumIdUnidadeAtual()),
          InfraDTO::$OPER_LOGICO_AND,
          'c3');
      ...
      $objOperacaoServicoDTO->adicionarCriterio(array('IdTipoProcedimento', 'IdUnidade'),
          array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array($objProcedimentoDTO->getNumIdTipoProcedimento(), SessaoSEI::getInstance()->getNumIdUnidadeAtual()),
          InfraDTO::$OPER_LOGICO_AND,
          'c4');
  ...
  private function obterProcesso($dblIdProcedimento, $strProtoloProcedimento){
    ...
    }else if ($strProtoloProcedimento!=null){
  ...
  private function obterDocumento($dblIdDocumento, $strProtocoloDocumento){
    ...
    }else if ($strProtocoloDocumento!=null){
