    ...
    case 'publicacao_alterar_agendamento':
      ...
      if (isset($_POST['sbmAlterarPublicacao'])) {
        ...
        try{
          ...
          PaginaSEI::getInstance()->setStrMensagem('Alteração do agendamento em "'.$objPublicacaoDTOAlteracao->getDtaDisponibilizacao().'" realizado com sucesso.');
...
?>
	<div id="divDocumento" class="infraAreaDados" style="height:18em;">
	  ...
	  <img id="imgCalDisponibilizacao" title="Selecionar Disponibilização" alt="Selecionar Disponibilização" src="/infra_css/imagens/calendario.gif" class="infraImg" onclick="infraCalendario('txtDisponibilizacao',this);" <?=$strOcultar?> />
