...
abstract class InfraDTO
{
    ...
    protected function configurarExclusaoLogica($strAtributo = 'SinAtivo', $valorDesativado = 'N')
    {
        ...
        if (!isset(self::$arrMetaDados[$this->strClasse][$strAtributo])) {
            throw new InfraException('Atributo [' . $strAtributo . '] da Exclusão Lógica não encontrado no DTO. Certifique-se que o atributo foi declarado antes da invocação à configurarExclusaoLogica()');
        }
     ...
     * @return void
     */
    public function retTodos($bolRelacionados = false)
    {
