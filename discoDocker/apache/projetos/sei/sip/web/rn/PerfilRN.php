...
//          echo '<pre>';print_r($arrMenus);die($strMenu.'#'.$strRecurso);
  ...
  public function compararPerfil(CompararPerfilDTO $objCompararPerfilDTO) {
    try{
      ...
      //Valida Permissao
      SessaoSip::getInstance()->validarAuditarPermissao('perfil_comparar',__METHOD__,$objCompararPerfilDTO);
      ...
      if ($objCompararPerfilDTO->getStrStaBaseComparacao()=='L') {//base (L)ocal
        ...
        if (InfraString::isBolVazia($objCompararPerfilDTO->getStrSiglaOrgaoSistemaDestino())) {
          $objInfraException->adicionarValidacao('Órgão do sistema remoto não informado.');
        }

        if (InfraString::isBolVazia($objCompararPerfilDTO->getStrSiglaSistemaDestino())) {
          $objInfraException->adicionarValidacao('Sistema remoto não informado.');
        }

        if (InfraString::isBolVazia($objCompararPerfilDTO->getStrPerfilDestino())) {
      ...
      if ($objCompararPerfilDTO->getStrStaBaseComparacao()=='R') {//base (R)emota
        ...
        $objSistemaRemotoDTO->setStrSiglaOrgao($objCompararPerfilDTO->getStrSiglaOrgaoSistemaDestino());
        $objSistemaRemotoDTO->setStrSigla($objCompararPerfilDTO->getStrSiglaSistemaDestino());
        ...
        $objPerfilRemotoDTO->setStrNome($objCompararPerfilDTO->getStrPerfilDestino());
        ...
        $objSistemaRemotoDTO = new SistemaDTO();
        $objSistemaRemotoDTO->retTodos();
        $objSistemaRemotoDTO->setNumIdOrgao($objCompararPerfilDTO->getNumIdOrgaoSistemaDestino());
        $objSistemaRemotoDTO->setNumIdSistema($objCompararPerfilDTO->getNumIdSistemaDestino());
        $objSistemaRemotoDTO = $objSistemaRN->consultar($objSistemaRemotoDTO);
        if ($objSistemaRemotoDTO==null){
          $objInfraException->lancarValidacao('Sistema Destino não encontrado.');
        }
        ...
        $objPerfilRemotoDTO = new PerfilDTO();
        $objPerfilRemotoDTO->retTodos();
        $objPerfilRemotoDTO->setNumIdPerfil($objCompararPerfilDTO->getNumIdPerfilDestino());
        $objPerfilRemotoDTO->setNumIdSistema($objSistemaRemotoDTO->getNumIdSistema());
        $objPerfilRemotoDTO = $this->consultar($objPerfilRemotoDTO);
        if ($objPerfilRemotoDTO==null){
          $objInfraException->lancarValidacao('Perfil Destino não encontrado.');
      ...
      //Consulta sistema local
			...
			$objSistemaLocalDTO->setNumIdOrgao($objCompararPerfilDTO->getNumIdOrgaoSistemaOrigem());
			$objSistemaLocalDTO->setNumIdSistema($objCompararPerfilDTO->getNumIdSistemaOrigem());
      $objSistemaLocalDTO = $objSistemaRN->consultar($objSistemaLocalDTO);
			...
			$objPerfilLocalDTO->setNumIdPerfil($objCompararPerfilDTO->getNumIdPerfilOrigem());
      ...
      $objCompararPerfilDTO->setArrObjRecursoOrigemDTO($arrObjRecursoLocalDTO);
      $objCompararPerfilDTO->setArrObjRecursoDestinoDTO($arrObjRecursoRemotoDTO);
...
//          }
        ...
        $objCompararPerfilDTO->setArrObjRecursoOrigemDTO($arrObjRecursoLocalDTOtemp);
        $objCompararPerfilDTO->setArrObjRecursoDestinoDTO($arrObjRecursoRemotoDTOtemp);
      }
      //================================================================================================================
