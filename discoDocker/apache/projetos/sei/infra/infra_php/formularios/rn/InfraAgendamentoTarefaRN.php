...
class InfraAgendamentoTarefaRN extends InfraRN {
  ...
  public function listarValoresPeriodicidadeExecucao(){
    try {
      ...
      $objInfraAgendamentoPeriodicidadeDTO = new InfraAgendamentoPeriodicidadeDTO();
      $objInfraAgendamentoPeriodicidadeDTO->setStrStaPeriodicidadeExecucao(self::$PERIODICIDADE_EXECUCAO_DIA_SEMANA);
  ...
  public function executar(InfraAgendamentoTarefaDTO $objInfraAgendamentoTarefaDTO){
    ...
    $objInfraAgendamentoTarefaDTOBanco->setNumIdInfraAgendamentoTarefa($objInfraAgendamentoTarefaDTO->getNumIdInfraAgendamentoTarefa());
    ...
    $objInfraAgendamentoTarefaDTO2->setNumIdInfraAgendamentoTarefa($objInfraAgendamentoTarefaDTO->getNumIdInfraAgendamentoTarefa());
