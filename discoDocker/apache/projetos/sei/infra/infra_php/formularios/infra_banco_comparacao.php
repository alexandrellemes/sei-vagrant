    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($objInfraComparacaoBancoDTO->getStrSinComparaQtdeRegistrosTabela() == 'S'){
        ...
        if ($arrObjInfraComparacaoBancoDTO_Tabela[$i]->getNumQtdeRegistrosTabelaOrigem()!=$arrObjInfraComparacaoBancoDTO_Tabela[$i]->getNumQtdeRegistrosTabelaDestino()){
          $strResultadoTabela .= ' &lt;&gt; '.$arrObjInfraComparacaoBancoDTO_Tabela[$i]->getNumQtdeRegistrosTabelaDestino();
        }
...
#divSinComparaTipoColunasTabela {position:absolute;left:0;top:80%;}
#divSinComparaQtdeRegistrosTabela {position:absolute;left:0;top:84%;}
#divSinComparaMaxIdTabela {position:absolute;left:0;top:88%;}
#divSinExibirSomenteDiferencas {position:absolute;left:0;top:92%;}
