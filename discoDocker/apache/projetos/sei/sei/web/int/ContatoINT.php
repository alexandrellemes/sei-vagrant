    ...
    if (count($arrIdContatoSistema)){
      ...
      foreach($arrFiltro as $arrPorNome) {
        foreach ($arrPorNome as $strNome => $arrObjUsuarioDTO) {
          ...
          $ret[$numIdContatoAgrupador]->setStrNome(ContatoINT::formatarNomeSiglaRI1224($strNome, implode(', ', array_unique(InfraArray::converterArrInfraDTO($arrObjUsuarioDTO,'Sigla')))));
