...
try {
  ...
  if ($_GET['acao']=='documento_gerar' ||
    ...
    $strTituloLabelNumero = 'Número / Nome na Árvore:';
  ...
  <form id="frmDocumentoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'].$strParametros)?>" style="display:inline;">
    ...
    <div id="divTextoInicial" class="infraAreaDados" style="height:10em;">
      <fieldset id="fldTextoInicial" class="infraFieldset">
        ...
        <div id="divOptTextoPadrao" class="infraDivRadio">
          ...
          <span id="spnTextoPadrao"><label id="lblTextoPadrao" for="optTextoPadrao" class="infraLabelRadio" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>">Texto Padrão</label></span>
        </div>
    ...
    <div id="divFormato" class="infraAreaDados" style="height:9em;">
      ...
      <fieldset id="fldFormato" class="infraFieldset">
        <legend class="infraLegend">&nbsp;Formato&nbsp;<a href="javascript:void(0);" id="ancAjudaFormato" <?=PaginaSEI::montarTitleTooltip('Selecione a opção "Nato-digital" se o arquivo a ser registrado foi criado ou recebido por meio eletrônico.'."\n\n\n".'Selecione a opção "Digitalizado nesta Unidade" somente se o arquivo a ser registrado foi produzido a partir da digitalização de um documento em papel.')?>><img src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/ajuda.gif" class="infraImg"/></a> </legend>
    ...
    <div id="divDestinatarios" class="infraAreaDados" style="height:11em;">
      ...
      <div id="divOpcoesDestinatarios">
        <img id="imgSelecionarGrupo" onclick="objLupaDestinatarios.selecionar(700,500);" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/lupa.gif" title="Selecionar Contatos para Destinatários" alt="Selecionar Contatos para Destinatários" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
        <img id="imgAlterarDestinatario" onclick="objLupaDestinatarios.alterar();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/alterar.gif" alt="Consultar/Alterar Dados do Destinatário Selecionado" title="Consultar/Alterar Dados do Destinatário Selecionado" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>
        <img id="imgRemoverDestinatarios" onclick="objLupaDestinatarios.remover();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/remover.gif" alt="Remover Destinatários Selecionados" title="Remover Destinatários Selecionados" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"/>
        <br />
        <img id="imgDestinatariosAcima" onclick="objLupaDestinatarios.moverAcima();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_acima_select.gif" alt="Mover Acima Destinatário Selecionado" title="Mover Acima Destinatário Selecionado" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
        <img id="imgDestinatariosAbaixo" onclick="objLupaDestinatarios.moverAbaixo();" src="<?=PaginaSEI::getInstance()->getDiretorioImagensGlobal()?>/seta_abaixo_select.gif" alt="Mover Abaixo Destinatário Selecionado" title="Mover Abaixo Destinatário Selecionado" class="infraImg" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
      </div>
    </div>
