...
class ProtocoloINT extends InfraINT
{
  ...
  public static function pesquisarLinkEditor($dblIdProcedimento, $dlbIdDocumento, $strIdProtocolo)
  {
    ...
    if ($objProtocoloDTO->getNumCodigoAcesso() < 0) {
      ...
      //permite referencias para documentos sigilosos do proprio processo
      if ($objProtocoloDTO->getStrStaNivelAcessoGlobal()==ProtocoloRN::$NA_SIGILOSO &&
          ($objProtocoloDTO->getStrStaProtocolo()==ProtocoloRN::$TP_DOCUMENTO_GERADO || $objProtocoloDTO->getStrStaProtocolo()==ProtocoloRN::$TP_DOCUMENTO_RECEBIDO) &&
          $objProtocoloDTO->getDblIdProcedimentoDocumento() != $dblIdProcedimento) {
        $objInfraException->lancarValidacao('Protocolo não encontrado.');
      }
    }
