...
class InfraControlador {
  ...
  public static function processar($strAcao, $objInfraPagina, $objInfraSessao, $objInfraIBanco, $objInfraLog = null, $objInfraCache = null){
    ...
    switch($strAcao) {
      ...
      case 'infra_configurar':
        PaginaInfra::getInstance()->montarPaginaConfiguracao();
