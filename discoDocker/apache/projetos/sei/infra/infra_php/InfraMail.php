<?
  ...
  */
  ...
  class InfraMail {
     ...
     * @return void
     */    
    public static function enviarConfigurado(InfraConfiguracao $objInfraConfiguracao, $strDe, $strPara, $strCC, $strCCO, $strAssunto, $strCorpo, $strTipoCorpo="text/plain", $arrAnexos=null, $objInfraLog = null) {
      
      try{

        self::validarEmail($objInfraConfiguracao, $strDe, $strPara, $strCC, $strCCO, $strAssunto, $strCorpo, $strTipoCorpo, $arrAnexos);
        ...
        if (strpos(strtoupper($e->__toString()),'THE FOLLOWING RECIPIENTS FAILED')!==false){
          ...
          $strMsg = 'Não foi possível enviar para os destinatários: '.$match[1];
    ...
    public static function validarEmail(InfraConfiguracao $objInfraConfiguracao, $strDe, $strPara, $strCC, $strCCO, $strAssunto, $strCorpo, $strTipoCorpo="text/plain", $arrAnexos=null){
