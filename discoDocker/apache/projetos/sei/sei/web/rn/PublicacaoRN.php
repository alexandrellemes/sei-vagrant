  ...
  private function validarDtaDisponibilizacaoRN1035(PublicacaoDTO $objPublicacaoDTO, InfraException $objInfraException){
	...
	protected function retornarPublicacoesRelacionadasConectado($parArrObjPublicacaoDTO) {
	  try{
	    ...
	    if (count($parArrObjPublicacaoDTO)){
	...
	public function validarAlteracaoAgendamentoPublicacao(PublicacaoDTO $objPublicacaoDTO, InfraException $objInfraException, PublicacaoDTO $objPublicacaoBancoDTO = null) {
    ...
    //		$objInfraException->lancarValidacao('Não é possível alterar um agendamento que já foi publicado.');
		//}
	...
	protected function alterarAgendamentoRN1042Controlado(PublicacaoDTO $objPublicacaoDTO){
	    ...
	    $objPublicacaoBancoDTO->retStrStaEstado();
			...
			if (!$objPublicacaoDTO->isSetDblIdDocumento()){
        ...
        $objPublicacaoDTO->setStrNomeVeiculoPublicacao($objPublicacaoBancoDTO->getStrNomeVeiculoPublicacao());
			...
			$this->validarAlteracaoAgendamentoPublicacao($objPublicacaoDTO, $objInfraException, $objPublicacaoBancoDTO);
