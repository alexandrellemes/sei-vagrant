 ...
 */    }else{
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=uf_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_uf='.$arrObjUfDTO[$i]->getNumIdUf()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/consultar.gif" title="Consultar Estado" alt="Consultar Estado" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=uf_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_uf='.$arrObjUfDTO[$i]->getNumIdUf()).'" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/alterar.gif" title="Alterar Estado" alt="Alterar Estado" class="infraImg" /></a>&nbsp;';
      }

/* 
      if ($bolAcaoDesativar){
        $strResultado .= '<a href="#ID-'.$arrObjUfDTO[$i]->getNumIdUf().'"  onclick="acaoDesativar(\''.$arrObjUfDTO[$i]->getNumIdUf().'\',\''.$arrObjUfDTO[$i]->getStrSigla().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/desativar.gif" title="Desativar Estado" alt="Desativar Estado" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar){
        $strResultado .= '<a href="#ID-'.$arrObjUfDTO[$i]->getNumIdUf().'"  onclick="acaoReativar(\''.$arrObjUfDTO[$i]->getNumIdUf().'\',\''.$arrObjUfDTO[$i]->getStrSigla().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/reativar.gif" title="Reativar Estado" alt="Reativar Estado" class="infraImg" /></a>&nbsp;';
      }
 */

      if ($bolAcaoExcluir){
        $strResultado .= '<a href="#ID-'.$arrObjUfDTO[$i]->getNumIdUf().'"  onclick="acaoExcluir(\''.$arrObjUfDTO[$i]->getNumIdUf().'\',\''.$arrObjUfDTO[$i]->getStrSigla().'\');" tabindex="'.PaginaSEI::getInstance()->getProxTabTabela().'"><img src="imagens/excluir.gif" title="Excluir Estado" alt="Excluir Estado" class="infraImg" /></a>&nbsp;';
      }
